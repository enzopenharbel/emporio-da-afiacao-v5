...
export default function App() {
  ...
  <div className="flex items-center w-[400px] bg-black border-2 border-yellow-400/40 rounded-xl overflow-hidden transition-all duration-300 shadow-md hover:shadow-yellow-400/30 focus-within:shadow-yellow-400/60 focus-within:border-yellow-400">
